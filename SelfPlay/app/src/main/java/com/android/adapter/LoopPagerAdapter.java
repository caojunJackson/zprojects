...
import com.android.hintview.HintView;
...
public abstract class LoopPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        Log.i("fenghaitao", "instantiateItem = "+realPosition);
    ...
    private View findViewByPosition(ViewGroup container, final int position){
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.i("fenghaitao", "instantiateItem uuuuuuuuuuuuuuuuuuuu= "+position);
            }
        });
