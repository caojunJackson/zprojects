 ...
 * Original file: /home/fht/work/workman/gitHub/zprojects/FingerprintCallback/src/com/android/internal/policy/IKeyguardStateCallback.aidl
 */
...
case TRANSACTION_onAntiTheftStateChanged:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
this.onAntiTheftStateChanged(_arg0);
reply.writeNoException();
return true;
}
}
...
@Override public void onAntiTheftStateChanged(boolean antiTheftEnabled) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(((antiTheftEnabled)?(1):(0)));
mRemote.transact(Stub.TRANSACTION_onAntiTheftStateChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_onAntiTheftStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
}
...
public void onAntiTheftStateChanged(boolean antiTheftEnabled) throws android.os.RemoteException;
}
