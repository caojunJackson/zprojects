 ...
 * Original file: /home/fht/work/workman/gitHub/zprojects/FingerprintCallback/src/com/android/internal/policy/IKeyguardService.aidl
 */
...
int _arg0;
_arg0 = data.readInt();
this.onFinishedGoingToSleep(_arg0);
return true;
}
...
/**
     ...
     * or {@link #OFF_BECAUSE_OF_TIMEOUT}.
     */
@Override public void onFinishedGoingToSleep(int reason) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
static final int TRANSACTION_onStartedGoingToSleep = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_onFinishedGoingToSleep = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_onStartedWakingUp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
...
static final int TRANSACTION_onScreenTurnedOff = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
...
static final int TRANSACTION_onBootCompleted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_startKeyguardExitAnimation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_onActivityDrawn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
}
/**
     * Sets the Keyguard as occluded when a window dismisses the Keyguard with flag
     * FLAG_SHOW_ON_LOCK_SCREEN.
...
/**
     ...
     * or {@link #OFF_BECAUSE_OF_TIMEOUT}.
     */
public void onFinishedGoingToSleep(int reason) throws android.os.RemoteException;
/**
     * Called when the device has started waking up.
     */
