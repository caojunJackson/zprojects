...
public class HorizontalProgressBarWithNumber extends ProgressBar {
    ...
    private static final int DEFAULT_HEIGT_UNREACHED_PROGRESS_BAR = 2;
     ...
     */
    protected int mUnReachedProgressBarHeight = dp2px(DEFAULT_HEIGT_UNREACHED_PROGRESS_BAR);
    ...
    /*
    高度呢，只考虑不是EXACTLY的情况（用户明确指定了，我们就不管了），
    根据padding和进度条宽度算出自己想要的，如果非EXACTLY下，我们进行exceptHeight封装，传入给控件进行测量高度。
     */
    @Override
    ...
    protected synchronized void onDraw(Canvas canvas) {
      canvas.save();
        ...
        //绘制的文本
        //String text = secondsToTime(getProgress());
